...
output$ICC <- renderPlot({
   a <- as.numeric(input$difficulty3)
   b <- as.numeric(input$discrimination3)
...
$D$ is 1.7 for the 1PL model and 1 for the Rasch model, and $a_j$ is
the discrimination parameter, and $c_j$ is the guessing paramter.
